...
public class Board {
    ...
    // Carga los botes y los posiciona
    public void initBoats(){
            boats = new Boat[getBOARD_BOATS_COUNT()];
            
            // abri ficher
            
        File oldfile = new File("C:\\archivosprog\\boat_out.txt");
        File newfile = new File("C:\\archivosprog\\boat_in.txt");
        ...
        try{
            ...
            // leer linea
            {
                ...
                boats[i] = new Boat();
                getBoats()[i].setBoat(lineaseparadas);
